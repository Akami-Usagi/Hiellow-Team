...
namespace HogarGestor.App.Persistencia
{
    public class AppContext : DbContext
    {
        ...
        public DbSet<AsignarMedico> AsignarMedicos { get; set; }
        ...
        public DbSet<Joven> Jovens { get; set; }
        //public DbSet<AsignarMedico> AsignarMedicos { get; set; }
        //*************************************************************
        ...
        )
        {
            if (!optionsBuilder.IsConfigured)
                optionsBuilder
                    .UseSqlServer("Data Source = (localdb)\\MSSQLLocalDB; Initial Catalog = HogarGestorData17;Trusted_Connection=True;");
